			    ...
			    <div class="row">    
					...
					<div class="col-xs-6 text-center">
						<h4 id="coord">Nos coordonnées :</h4>
							<a id="adresse" href="https://goo.gl/maps/2LfEG8tXsvp" title="Ouvrir la carte interactive..." target="_blank"><i class="fa fa-2x fa-map-marker"></i> Centre d'hébergement Le PierLou, Le Bourg - 63980 ÉCHANDELYS</a>
							<br/>
