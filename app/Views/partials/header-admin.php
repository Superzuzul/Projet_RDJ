    	...
    	<header>
    	    ...
    	    <aside id="cont-menu">
                <ul id="menu-ul-global">
                    ...
                    <li><a href="<?php echo $this->url("admin_sejour") ?>">Administration</a>
                        <ul id="ssmenu-ul3">
                            <li><a href="<?php echo $this->url("admin_sejour") ?>">Modifier un séjour</a></li>
                            <li><a href="<?php echo $this->url("admin_membre") ?>">Ajouter un membre</a></li>
                        </ul>
                    </li>
                </ul>
            </aside>
