<?php
$this->insert('partials/header',['titre'=>"Espace Adhérent - Modification de votre mot de passe | RêvesdeJeux.com", 'description'=>"L'espace adhérent de Rêves de Jeux vous permet d'accéder à des contenus exclusifs : photos, chat entre membres,..."]);
?>
